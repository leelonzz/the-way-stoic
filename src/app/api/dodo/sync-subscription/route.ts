    ...
    if (dodoSubscription && dodoSubscription.status === 'active') {
      ...
      updateData = {
        ...
        subscription_expires_at:
          dodoSubscription.current_period_end ||
      ...
      console.log(
        '⚠️ No active subscription found, checking recent payment history'
      )
      ...
      return NextResponse.json({
        success: false,
        message:
          'No active subscription found. If you recently paid, please contact support.',
        currentStatus: {
          plan: profile.subscription_plan,
          status: profile.subscription_status,
        },
