...
export function FeaturesSection() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Visualize your life's journey with a powerful reminder of time's precious nature.",
      details: [
    ...
    },
    {
      ...
      title: 'Daily Wisdom',
      description:
        'Discover curated quotes and teachings from the greatest stoic philosophers throughout history.',
      details: [
        'Daily featured quotes with context',
        'Save your favorite wisdom',
        'Searchable philosophy library',
      ],
      color: 'sage',
      badge: 'Learning',
    },
    {
      ...
      description:
        'Transform ancient wisdom into actionable insights for modern challenges and daily decisions.',
      details: [
    ...
    },
    {
      ...
      description:
        'Monitor your philosophical growth through streaks, insights, and personal development metrics.',
      details: [
        'Journal consistency tracking',
        'Mood and gratitude trends',
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => {
            ...
            return (
              <Card
                key={index}
                className="group hover:shadow-xl hover:shadow-black/15 transition-all duration-300 bg-card/50 backdrop-blur-sm"
              >
                <CardHeader className="space-y-4">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-sage mt-2">
                      {feature.description}
                    </CardDescription>
                  </div>
                </CardHeader>
