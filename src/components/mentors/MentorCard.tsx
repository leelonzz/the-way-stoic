...
export function MentorCard({
  ...
  return (
    <Card
      className="bg-transparent shadow-lg transition-transform duration-300 hover:shadow-2xl hover:scale-105"
      style={{
    ...
    >
      ...
      <CardContent className="space-y-4">
        ...
        <div className="p-3 bg-hero/50 rounded-lg border-l-4 border-accent">
          <p className="text-sm italic text-ink">&ldquo;{greeting}&rdquo;</p>
        </div>
