-- Create user_preferences table (safe version)
...
-- Create function to handle preference updates (drop if exists first)
DROP FUNCTION IF EXISTS public.handle_preference_update();
