...
export function PhilosophySection(): JSX.Element {
  ...
  return (
    <section
      id="philosophy"
      className="py-24 bg-gradient-to-br from-parchment to-hero"
    >
      <div className="container px-4">
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          <p className="text-lg text-stone leading-relaxed">
            Engage with three legendary stoic philosophers through AI-powered
            conversations that bring their wisdom to life for your modern
            challenges.
          </p>
        </div>
            ...
            >
              <CardContent className="p-0">
                ...
                >
                  ...
                  <h3 className="text-lg font-inknut font-bold text-ink mb-1">
                    {philosopher.name}
                  </h3>
                  <p
