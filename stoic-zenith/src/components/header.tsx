      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-16">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className="hidden lg:block bg-primary hover:bg-primary/90 text-white font-inknut text-sm md:text-base xl:text-lg px-4 md:px-8 py-2 md:py-3 transition-colors flex items-center justify-center"
          >
            Log in
          </Button>
