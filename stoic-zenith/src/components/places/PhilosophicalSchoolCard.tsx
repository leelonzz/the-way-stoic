...
export function PhilosophicalSchoolCard({
  school,
}: PhilosophicalSchoolCardProps) {
    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <span
            className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getSchoolColor(school.philosophy)}`}
          >
            {school.philosophy}
          </span>
        </div>
