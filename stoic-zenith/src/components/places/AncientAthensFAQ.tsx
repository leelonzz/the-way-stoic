...
import {
  getAllAncientAthensFAQ,
  getAncientAthensFAQByCategory,
  type AncientAthensFAQItem,
} from '@/lib/ancientAthensFAQ'
      ...
      >
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            <span
              className={`inline-flex items-center gap-1 px-2 py-1 rounded text-xs font-medium ${getCategoryColor(item.category)}`}
            >
...
export function AncientAthensFAQ({
  ...
  const [selectedCategory, setSelectedCategory] = useState<
    AncientAthensFAQItem['category'] | 'all'
  >(initialCategory)
  ...
  const categories = [
    { id: 'all' as const, name: 'All Topics', count: allFAQs.length },
    {
      ...
      count: getAncientAthensFAQByCategory('general').length,
    },
    {
      id: 'stoicism' as const,
      name: 'Stoicism',
      count: getAncientAthensFAQByCategory('stoicism').length,
    },
    {
      id: 'schools' as const,
      name: 'Philosophical Schools',
      count: getAncientAthensFAQByCategory('schools').length,
    },
    {
      id: 'locations' as const,
      name: 'Locations & Sites',
      count: getAncientAthensFAQByCategory('locations').length,
    },
    {
      id: 'visiting' as const,
      name: 'Visiting Today',
      count: getAncientAthensFAQByCategory('visiting').length,
    },
  ]
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p
            ...
            style={{ fontFamily: 'Poppins, sans-serif' }}
          >
            Common questions about Athens' philosophical heritage, answered with
            historical context and practical information for modern visitors.
          </p>
        </div>
