...
export const ancientAthensFAQ: AncientAthensFAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Athens became philosophy's epicenter through its democratic culture that valued debate, economic prosperity that allowed intellectual leisure, and strategic location that attracted scholars from across the Mediterranean. The city's unique institutions - from the democratic assembly to the gymnasium - created spaces for philosophical inquiry. Most importantly, Athens produced a continuous tradition of philosophical teaching, from Socrates to his student Plato, to Plato's student Aristotle, creating an intellectual dynasty that attracted students worldwide.",
    category: 'general',
...
// Helper functions
export function getAncientAthensFAQByCategory(
  category: AncientAthensFAQItem['category']
): AncientAthensFAQItem[] {
