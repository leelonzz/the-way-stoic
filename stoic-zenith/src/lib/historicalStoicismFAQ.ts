...
export const historicalStoicismFAQ: HistoricalFAQItem[] = [
  ...
  {
    question: "How did the three main periods of Stoicism differ from each other?",
    ...
    category: "general",
    keyFigures: ["Zeno of Citium", "Cato the Younger", "Marcus Aurelius", "Seneca", "Epictetus"],
  ...
  },
  {
    ...
    answer: "Diogenes of Babylon (c. 230-150 BCE) was a crucial figure who led Stoicism during the decline of the Seleucid Empire. As head of the Stoic school, he was part of the famous 'Philosophical Embassy' to Rome in 155 BCE, along with representatives from other schools. This mission introduced Stoic philosophy directly to Roman aristocrats and marked the beginning of Stoicism's transformation from a Greek to a Roman philosophy.",
    category: "hellenistic",
  ...
  {
    question: "Why was Cato the Younger considered the ideal Stoic during the Republic's fall?",
  ...
  // Additional Historical Context Questions
  {
    ...
    relatedEvents: ["Battle of Actium", "End of Roman Republic", "Beginning of Principate"]
  },
  {
    question: "What was the Philosophical Embassy to Rome (155 BCE) and why was it significant?",
    answer: "In 155 BCE, Athens sent three philosophers to Rome as ambassadors: Diogenes of Babylon (Stoic), Carneades (Academic), and Critolaus (Peripatetic). They were negotiating a fine imposed on Athens, but their philosophical lectures captivated Roman audiences. This event marked the formal introduction of Greek philosophy to Roman elite culture and began Stoicism's transformation from a Greek to a Roman philosophy.",
    category: "hellenistic",
    period: "Late Hellenistic Period",
    keyFigures: ["Diogenes of Babylon", "Carneades", "Critolaus", "Cato the Elder"],
    relatedEvents: ["Philosophical Embassy to Rome", "Roman conquest of Greece", "Cultural Hellenization of Rome"]
  },
  {
    question: "How did the Antonine Plague (165-180 CE) influence Marcus Aurelius's Stoicism?",
    answer: "The Antonine Plague devastated the Roman Empire during Marcus Aurelius's reign, killing millions including possibly the emperor himself. This catastrophe deeply influenced his 'Meditations,' where he frequently reflects on death, impermanence, and accepting what cannot be controlled. The plague reinforced core Stoic teachings about the fragility of life and the importance of focusing on virtue rather than external circumstances.",
    category: "roman-empire",
    period: "High Roman Empire",
    keyFigures: ["Marcus Aurelius", "Galen"],
    relatedEvents: ["Antonine Plague", "Marcomannic Wars", "Death of Marcus Aurelius"]
  },
  {
    question: "Why did Stoicism decline after Marcus Aurelius's death in 180 CE?",
    answer: "Several factors contributed to Stoicism's decline: the end of the Pax Romana brought instability that made philosophical reflection less practical; the rise of Christianity offered competing answers to life's meaning; and the lack of major Stoic teachers after Marcus Aurelius meant the tradition lost intellectual leadership. The empire's increasing focus on survival rather than philosophical excellence also reduced demand for Stoic education among elites.",
    category: "roman-empire",
    period: "Late Roman Empire",
    keyFigures: ["Marcus Aurelius", "Commodus", "Early Christian Fathers"],
    relatedEvents: ["Death of Marcus Aurelius", "Crisis of the Third Century", "Rise of Christianity", "End of Antonine Dynasty"]
  }
]

// Helper function to get FAQ data by category
export function getHistoricalFAQByCategory(category: HistoricalFAQItem['category']): HistoricalFAQItem[] {
