...
import { AncientAthensFAQ } from '@/components/places/AncientAthensFAQ'
      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="bg-blue-50 rounded-lg p-6 mb-12">
          ...
          <nav className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
            ...
            >
              1. Why Athens Became Philosophy's Birthplace
            </a>
            <a
              href="#stoa-poikile"
              className="text-blue-600 hover:text-blue-800 transition-colors"
            >
              2. The Stoa Poikile - Birthplace of Stoicism
            </a>
            <a
              href="#platos-academy"
              className="text-blue-600 hover:text-blue-800 transition-colors"
            >
              3. Plato's Academy - The First University
            </a>
            <a
              href="#aristotles-lyceum"
              className="text-blue-600 hover:text-blue-800 transition-colors"
            >
              4. Aristotle's Lyceum - The Peripatetic School
            </a>
            <a
              href="#garden-epicurus"
              className="text-blue-600 hover:text-blue-800 transition-colors"
            >
              5. The Garden of Epicurus - Philosophical Opposition
            </a>
            <a
              href="#ancient-agora"
              className="text-blue-600 hover:text-blue-800 transition-colors"
            >
              6. The Agora - Philosophy in Public Space
            </a>
            <a
              href="#comparative-analysis"
              className="text-blue-600 hover:text-blue-800 transition-colors"
            >
              7. Comparative Analysis of Schools
            </a>
            <a
              href="#visiting-today"
              className="text-blue-600 hover:text-blue-800 transition-colors"
            >
              8. Visiting Ancient Sites Today
            </a>
            <a
              href="#faq"
              className="text-blue-600 hover:text-blue-800 transition-colors"
